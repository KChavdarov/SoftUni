...
async function loadProfile(user) {
    const memes = await getMemesByUserId(user.id);
    return myProfileTemplate(user, memes);
}

export function profilePage(context) {
    ...
    context.render(until(loadProfile(user), loader));
